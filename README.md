# Azure-Entra-Powershell-Scripts
A collection of PowerShell cmdlets and scripts designed forAzure-Entra administration. 
...
> 1. Connect-MgGraph -Scopes "User.ReadWrite.All","Group.ReadWrite.All" 
